...
public class Eastern_Conference_Fragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<Story>> {

    private static final String URL_STRING = "https://content.guardianapis.com/search?q=nba%20AND%20eastern%20conference&api-key=";

    private static final String DEV_KEY = "87cb8304-e614-430c-915f-7f088bdde4ad";

    private static final int EAST_CONF_LOADER_ID = 1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (isConnected(getActivity())) {
            getLoaderManager().initLoader(EAST_CONF_LOADER_ID, null, this);
        } else {
    ...
    public void onLoadFinished(Loader<ArrayList<Story>> loader, ArrayList<Story> data) {
        ...
        Toast.makeText(getActivity(),R.string.finished_loading, Toast.LENGTH_SHORT).show();
    }
